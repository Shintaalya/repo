...
if choose=='Home':
    ...
    def main():
        ...
        y adalah variabel target (output)
        X adalah variabel input (fitur)
        w0, w1, w2, ..., wn adalah koefisien yang akan ditentukan oleh model Linear Regression dengan Polynomial
        n adalah derajat Polynomial yang digunakan")
